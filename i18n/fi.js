const i18n = {
    ...
    "book-001-name": 'Book of Selection Spell',
    ...
    "task-001-description": "SQL-mestarin tie alkaa tästä - 'Hei Maailma!' käy kailotus mäen tuollapuolen.\n\nTehtävä: Taio kaikki taulun riimut esiin. 'Book of Selection Spell' sisältää kaiken mitä tarvitset.",
    "task-002-name": "Yksi ylitse muiden",
    "task-002-description": "Tarvitset vain yhden sarakkeen. 'Book of Selection Spell' sisältää kaiken mitä tarvitset.",
    "task-003-name": "Lohi-käärme",
    "task-003-description": "On aika taikoa esiin tuo lohi-käärme. Valitse sarakkeet olion luomiseksi. 'Book of Selection Spell' sisältää kaiken mitä tarvitset.",
