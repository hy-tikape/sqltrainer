...
const taskList = [
    ...
    new Task({id: "004", color: Colors.BLUE, xp: 50}),
    new Task({id: "005", color: Colors.BLUE, xp: 50}),
    new Task({id: "006", color: Colors.BLUE, xp: 50}),
    new Task({id: "007", color: Colors.BLUE, xp: 75}),
    new Task({id: "008", color: Colors.BLUE, xp: 100}),
    new Task({id: "009", color: Colors.GREEN, xp: 50}),
    new Task({id: "010", color: Colors.GREEN, xp: 50}),
    new Task({id: "011", color: Colors.GREEN, xp: 50}),
